...
out_dir=/data1/workspace/linxinliang/CoInteract/output_videos/sugar_fullbody_pose1_tightmanual_720p_noaudio_try1
mkdir -p $out_dir
echo ===== sugar fullbody pose1 tightmanual 720p noaudio start $(date '+%F %T') =====
...
python batch_infer.py \
  ...
  --csv_path /data1/workspace/linxinliang/CoInteract/examples/sugar_fullbody_tight_manual_720p_noaudio_pose1.csv \
  ...
  --cfg_scale 7.0
status=$?
echo ===== sugar fullbody pose1 tightmanual 720p noaudio end $(date '+%F %T') status=$status =====
