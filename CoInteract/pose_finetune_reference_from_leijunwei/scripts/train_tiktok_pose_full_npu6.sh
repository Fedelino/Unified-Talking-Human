...
DATASET_BASE_PATH="./data/tiktok_pose_full"
DATASET_CSV="${DATASET_BASE_PATH}/data.csv"
OUTPUT_PATH="./output/tiktok_pose_full"
...
test -f "${DATASET_CSV}" || {
  echo "Missing ${DATASET_CSV}. Run: bash scripts/prepare_tiktok_pose_dwpose_npu6.sh" >&2
  exit 1
}
