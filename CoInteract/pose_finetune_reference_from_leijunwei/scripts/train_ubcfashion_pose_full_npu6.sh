...
DATASET_BASE_PATH="./data/ubcfashion_pose_full"
DATASET_CSV="${DATASET_BASE_PATH}/data.csv"
OUTPUT_PATH="./output/ubcfashion_pose_full"
...
test -f "${DATASET_CSV}" || {
  echo "Missing ${DATASET_CSV}. Run: bash scripts/prepare_ubcfashion_pose_full.sh" >&2
  exit 1
}
