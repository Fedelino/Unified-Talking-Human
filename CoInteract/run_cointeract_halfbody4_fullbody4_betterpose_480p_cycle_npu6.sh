...
FULLBODY_OUT="/data1/workspace/linxinliang/CoInteract/output_videos/side_by_side_fullbody4_cointeract_og_betterpose_480p_20260626"
HALFBODY_OUT="/data1/workspace/linxinliang/CoInteract/output_videos/side_by_side_halfbody4_cointeract_og_betterpose_480p_20260626"
LOG_PATH="/data1/workspace/linxinliang/CoInteract/logs/side_by_side_halfbody4_fullbody4_cointeract_og_betterpose_480p_cycle_20260626.log"
TMP_ROOT="/tmp/side_by_side_halfbody4_fullbody4_cointeract_og_betterpose_480p_cycle_20260626"
COOLDOWN_SECONDS=90
MAX_ATTEMPTS=3
...
echo "===== CoInteract halfbody4+fullbody4 betterpose 480p cycle start $(date '+%F %T') =====" | tee -a "$LOG_PATH"
echo "visible_npu=${ASCEND_RT_VISIBLE_DEVICES}" | tee -a "$LOG_PATH"

run_csv_cycle "$HALFBODY_CSV" "$HALFBODY_OUT" "$TMP_ROOT/halfbody" "halfbody4_betterpose_480p"
run_csv_cycle "$FULLBODY_CSV" "$FULLBODY_OUT" "$TMP_ROOT/fullbody" "fullbody4_betterpose_480p"

echo "===== CoInteract halfbody4+fullbody4 betterpose 480p cycle end $(date '+%F %T') =====" | tee -a "$LOG_PATH"
