...
FULLBODY_CSV="/data1/workspace/linxinliang/CoInteract/examples/cointeract_fullbody4_m2v_20260625.csv"
HALFBODY_CSV="/data1/workspace/linxinliang/CoInteract/examples/cointeract_halfbody4_m2v_20260625.csv"
FULLBODY_OUT="/data1/workspace/linxinliang/CoInteract/output_videos/side_by_side_fullbody4_cointeract_og_20260625"
HALFBODY_OUT="/data1/workspace/linxinliang/CoInteract/output_videos/side_by_side_halfbody4_cointeract_og_20260625"
LOG_PATH="/data1/workspace/linxinliang/CoInteract/logs/side_by_side_fullbody4_halfbody4_cointeract_og_cycle_20260625.log"
TMP_ROOT="/tmp/side_by_side_fullbody4_halfbody4_cointeract_og_cycle_20260625"
COOLDOWN_SECONDS=90
MAX_ATTEMPTS=3
...
echo "===== CoInteract fullbody4+halfbody4 cycle start $(date '+%F %T') =====" | tee -a "$LOG_PATH"
echo "visible_npu=${ASCEND_RT_VISIBLE_DEVICES}" | tee -a "$LOG_PATH"

run_csv_cycle "$FULLBODY_CSV" "$FULLBODY_OUT" "$TMP_ROOT/fullbody" "fullbody4"
run_csv_cycle "$HALFBODY_CSV" "$HALFBODY_OUT" "$TMP_ROOT/halfbody" "halfbody4"

echo "===== CoInteract fullbody4+halfbody4 cycle end $(date '+%F %T') =====" | tee -a "$LOG_PATH"
