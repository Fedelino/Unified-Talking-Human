...
out_dir="/data1/workspace/linxinliang/CoInteract/output_videos/patched_m2v_halfbody_720p_20260623"
mkdir -p "$out_dir"
echo "===== patched m2v halfbody 720p start $(date '+%F %T') ====="
...
python batch_infer.py \
  ...
  --cfg_scale 7.0
status=$?
echo "===== patched m2v halfbody 720p end $(date '+%F %T') status=$status ====="
