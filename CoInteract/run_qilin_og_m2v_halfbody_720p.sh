...
out_dir="/data1/workspace/linxinliang/CoInteract/output_videos/qilin_og_m2v_halfbody_720p_20260622"
mkdir -p "$out_dir"
echo "===== qilin og m2v halfbody 720p start $(date '+%F %T') ====="
...
python batch_infer_qilin_og_m2v.py \
  ...
  --cfg_scale 7.0
status=$?
echo "===== qilin og m2v halfbody 720p end $(date '+%F %T') status=$status ====="
