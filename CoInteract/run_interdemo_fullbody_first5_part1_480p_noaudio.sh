...
out_dir=/data1/workspace/linxinliang/CoInteract/output_videos/interdemo_fullbody_first5_part1_480p_noaudio
mkdir -p $out_dir
echo ===== interdemo fullbody first5 part1 480p noaudio start $(date '+%F %T') =====
...
python batch_infer.py \
  ...
  --csv_path /data1/workspace/linxinliang/CoInteract/examples/cointeract_interdemo_fullbody_first5_part1.csv \
  ...
  --cfg_scale 7.0
status=$?
echo ===== interdemo fullbody first5 part1 480p noaudio end $(date '+%F %T') status=$status =====
