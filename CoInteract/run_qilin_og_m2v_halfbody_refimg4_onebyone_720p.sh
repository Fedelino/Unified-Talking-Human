...
CSV_PATH="/data1/workspace/linxinliang/CoInteract/examples/m2v_og/cointeract_qilin_og_m2v_halfbody_refimg4.csv"
OUTPUT_DIR="/data1/workspace/linxinliang/CoInteract/output_videos/qilin_og_m2v_halfbody_refimg4_720p_20260623"
LOG_PATH="/data1/workspace/linxinliang/CoInteract/logs/qilin_og_m2v_halfbody_refimg4_720p_20260623.log"
TMP_DIR="/tmp/cointeract_qilin_og_m2v_halfbody_refimg4_rows"
...
echo "===== qilin og m2v halfbody refimg4 720p start $(date '+%F %T') =====" | tee -a "$LOG_PATH"
...
echo "===== qilin og m2v halfbody refimg4 720p end $(date '+%F %T') =====" | tee -a "$LOG_PATH"
