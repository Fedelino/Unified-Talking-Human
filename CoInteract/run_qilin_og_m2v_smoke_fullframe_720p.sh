...
out_dir="/data1/workspace/linxinliang/CoInteract/output_videos/qilin_og_m2v_smoke_fullframe_720p_20260622"
mkdir -p "$out_dir"
echo "===== qilin og m2v smoke fullframe 720p start $(date '+%F %T') ====="
...
python batch_infer_qilin_og_m2v.py \
  ...
  --csv_path /data1/workspace/linxinliang/CoInteract/examples/m2v_og/cointeract_qilin_og_m2v_smoke_fullframe.csv \
  ...
  --cfg_scale 7.0
status=$?
echo "===== qilin og m2v smoke fullframe 720p end $(date '+%F %T') status=$status ====="
