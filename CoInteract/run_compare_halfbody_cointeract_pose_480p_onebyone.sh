...
CSV_PATH="/data1/workspace/linxinliang/CoInteract/examples/compare_halfbody_talkinghuman_480p.csv"
OUTPUT_DIR="/data1/workspace/linxinliang/CoInteract/output_videos/compare_halfbody_cointeract_pose_20260624_480p"
LOG_PATH="/data1/workspace/linxinliang/CoInteract/logs/compare_halfbody_cointeract_pose_20260624_480p.log"
TMP_DIR="/tmp/compare_halfbody_cointeract_pose_20260624_480p_rows"
...
echo "===== compare halfbody cointeract 480p start $(date '+%F %T') =====" | tee -a "$LOG_PATH"
...
echo "===== compare halfbody cointeract 480p end $(date '+%F %T') =====" | tee -a "$LOG_PATH"
