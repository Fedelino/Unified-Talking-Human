...
CSV_PATH="/data1/workspace/linxinliang/CoInteract/examples/compare_halfbody_talkinghuman_480p_noborder.csv"
OUTPUT_DIR="/data1/workspace/linxinliang/CoInteract/output_videos/compare_halfbody_cointeract_pose_20260624_480p_noborder"
LOG_PATH="/data1/workspace/linxinliang/CoInteract/logs/compare_halfbody_cointeract_pose_20260624_480p_noborder.log"
TMP_DIR="/tmp/compare_halfbody_cointeract_pose_20260624_480p_noborder_rows"
...
echo "===== compare halfbody cointeract 480p noborder start $(date '+%F %T') =====" | tee -a "$LOG_PATH"
...
echo "===== compare halfbody cointeract 480p noborder end $(date '+%F %T') =====" | tee -a "$LOG_PATH"
