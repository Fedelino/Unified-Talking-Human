...
def wan_parser():
    ...
    parser.add_argument("--pose_dropout_prob", type=float, default=0.5, help="Probability of dropping pose_video during training. Keep >0 for pose CFG support.")
    parser.add_argument("--face_loss_weight", type=float, default=1.0, help="Weight for face-token diffusion loss when face bbox metadata is available. 1.0 disables extra weighting.")
    return parser
