...
CSV="examples/refkv_smoke_onecase_20260814.csv"
COMMON=(
  --csv_path "$CSV"
  --height 832
  --width 480
...
run_case "p2v_idmethod_baseline_onecase_20260814"

run_case "p2v_idmethod_refkv_headattn_s010_onecase_20260814" \
...
run_case "p2v_idmethod_refkv_spatial_s005_onecase_20260814" \
...
python scripts/arcface_seed_selector.py \
  ...
  --row_index 0 \
  --data_base_path . \
  --output_dir output_videos/p2v_idmethod_arcface_seedselect_onecase_20260814 \
  ...
  > logs/p2v_idmethod_arcface_seedselect_onecase_20260814.log 2>&1
