...
CSV_PATH="$ROOT/examples/cointeract_tia2v_realperson30_20260630.csv"
OUT_DIR="$ROOT/output_videos/tia2v_realperson30_cointeract_20260630"
LOG_PATH="$ROOT/logs/tia2v_realperson30_cointeract_20260630.log"
TMP_DIR="/tmp/tia2v_realperson30_cointeract_20260630"
...
{
  echo "===== CoInteract T+A+I2V realperson30 start $(date '+%F %T') ====="
...
csv_path = Path("/data1/workspace/linxinliang/CoInteract/examples/cointeract_tia2v_realperson30_20260630.csv")
tmp_dir = Path("/tmp/tia2v_realperson30_cointeract_20260630")
...
echo "===== CoInteract T+A+I2V realperson30 end $(date '+%F %T') =====" | tee -a "$LOG_PATH"
