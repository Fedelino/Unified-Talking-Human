...
OUT_DIR="$ROOT/output_videos/tia2v_case007_latent_dwsw_30s_preview_20260710"
LOG_PATH="$ROOT/logs/tia2v_case007_latent_dwsw_30s_preview_20260710.log"
PYTHON_BIN="/data1/miniconda3/envs/interact_avatar/bin/python"
VISIBLE_NPU="${VISIBLE_NPU:-4}"

mkdir -p "$OUT_DIR" "$(dirname "$LOG_PATH")"

{
  echo "===== CoInteract TIA2V case007 latent DWSW 30s preview start $(date '+%F %T') ====="
...
echo "===== CoInteract TIA2V case007 latent DWSW 30s preview end $(date '+%F %T') =====" | tee -a "$LOG_PATH"
