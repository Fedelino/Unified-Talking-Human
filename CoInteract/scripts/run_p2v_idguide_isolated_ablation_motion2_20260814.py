...
DATE = "20260814"
CSV_PATH = ROOT / "examples" / "th_fullbody_001_custom_motion2_noaudio_baseline_20260814.csv"
NPUS = ["0", "1", "2", "4"]
...
POSE = "/data1/workspace/linxinliang/InteractAvatar/InterDemo/custom_motion/dwpose/motion2_pose.mp4"
...
def ensure_csv() -> None:
    ...
    with CSV_PATH.open("w", newline="", encoding="utf-8") as fh:
        ...
        writer.writerow(
            {
                "sample_id": "th_fullbody_001_custom_motion2_noaudio_baseline",
                "prompt": PROMPT,
                "audio": "",
...
def launch(variant, npu: str):
    out_dir = ROOT / "output_videos" / f"p2v_idguide_motion2_{variant['name']}_{DATE}"
    out_dir.mkdir(parents=True, exist_ok=True)
    log_path = ROOT / "logs" / f"p2v_idguide_motion2_{variant['name']}_{DATE}.log"
    env = os.environ.copy()
