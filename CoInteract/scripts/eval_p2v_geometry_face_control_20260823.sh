...
OUT="$ROOT/output_videos/p2v_geometry_face_control_20260823_eval"
...
for video in output_videos/p2v_geometry_face_control_20260823/*/*.mp4; do
  [[ -f "$video" ]] || continue
...
grep -H "mean\\|min\\|last\\|slope" "$OUT"/*.txt || true
