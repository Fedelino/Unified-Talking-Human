...
mkdir -p logs output_videos/p2v_stagea_vguidance_scale075_motion2_20260716
...
python batch_infer.py \
  ...
  --output_dir output_videos/p2v_stagea_vguidance_scale075_motion2_20260716 \
  --height 832 \
  --width 480 \
  --num_frames 80 \
  --num_clips 1 \
  ...
  --face_reference_guidance_scale 0.75 \
