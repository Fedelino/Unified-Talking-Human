...
NPU_ID="${1:?usage: $0 <npu_id>}"

cd /data1/workspace/linxinliang/CoInteract
source /data1/miniconda3/etc/profile.d/conda.sh
conda activate cointeract

OUT=output_videos/qalign_fb01_motion5_arcface_mid24283236_postseqall_s0005_full40_npu${NPU_ID}_20260731
rm -rf "$OUT"
mkdir -p "$OUT/debug_arcface"

ASCEND_RT_VISIBLE_DEVICES="$NPU_ID" PYTHONUNBUFFERED=1 python batch_infer.py \
