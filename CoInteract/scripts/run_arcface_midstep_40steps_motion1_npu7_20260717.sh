...
python batch_infer.py \
  ...
  --output_dir output_videos/p2v_arcface_midstep_40steps_motion1_npu7_20260717 \
  --height 832 \
  --width 480 \
  --num_frames 80 \
  --num_clips 1 \
  ...
  --arcface_guidance_steps 28,32,36 \
  ...
  --arcface_guidance_debug_dir output_videos/p2v_arcface_midstep_40steps_motion1_npu7_20260717/debug_arcface
