...
python batch_infer.py \
  ...
  --output_dir output_videos/p2v_arcface_midstep_smoke_motion1_20260717 \
  --height 832 \
  --width 480 \
  --num_frames 80 \
  --num_clips 1 \
  ...
  --arcface_guidance_debug_dir output_videos/p2v_arcface_midstep_smoke_motion1_20260717/debug_arcface
