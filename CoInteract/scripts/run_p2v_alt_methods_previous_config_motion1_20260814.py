...
DATE = "20260814"
CSV_PATH = ROOT / "examples" / "th_fullbody_001_custom_motion1_altmethods_20260814.csv"
NPUS = ["0", "1", "2", "4"]
...
VARIANTS = [
    ...
    {
        "name": "refkv_spatialcopy_s0025",
        "args": [
            "--reference_kv_guidance_scale", "0.025",
...
def ensure_csv() -> None:
    ...
    with CSV_PATH.open("w", newline="", encoding="utf-8") as fh:
        ...
        writer.writerow(
            {
                "sample_id": "th_fullbody_001_custom_motion1_altmethods",
                "prompt": PROMPT,
                "audio": "",
...
def launch(variant, npu: str):
    out_dir = ROOT / "output_videos" / f"p2v_altmethods_prevconfig_motion1_{variant['name']}_{DATE}"
    out_dir.mkdir(parents=True, exist_ok=True)
    log_path = ROOT / "logs" / f"p2v_altmethods_prevconfig_motion1_{variant['name']}_{DATE}.log"
    env = os.environ.copy()
